...
* Adds an [introduction guide](guides/introduction.md) covering the shape of the API: the three ways to reach a property, naming property values, character names, script extensions and the guards. Its examples run as doctests.
...
* Updates the underlying data to the final [Unicode 18.0](https://www.unicode.org/versions/Unicode18.0.0/) release (16 September 2026), adding the `Jurchen`, `Proto_Cuneiform` and `Seal` scripts, seven new blocks and ten new `Crown_*` joining groups.
...
This is the changelog for Unicode v1.21.1 released on March 16th, 2026.  For older changelogs please consult the release tag on [GitHub](https://github.com/elixir-unicode/unicode/tags)
...
This is the changelog for Unicode v1.21.0 released on January 19th, 2025.  For older changelogs please consult the release tag on [GitHub](https://github.com/elixir-unicode/unicode/tags)
...
* Add `Unicode.script_statistic/1` that returns the first index and grapheme count of the scripts in a string. This is useful to help derive the likely locale of a string. Determining the locale is outside the scope of this library but is required in [ex_cldr_person_names](https://hex.pm/packages/ex_cldr_person_names).
