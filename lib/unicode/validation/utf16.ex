defmodule Unicode.Validation.UTF16 do
  ...
  def replace_invalid(bytes, replacement \\ "�")
    ...
    do_replace(bytes, Unicode.Validation.encode_replacement(replacement, :utf16), <<>>)
  end
  ...
  defp do_replace(<<codepoint::utf16, rest::bits>>, replacement, acc) do
    do_replace(rest, replacement, <<acc::bits, codepoint::utf16>>)
  end
