defmodule Unicode.Validation.UTF32 do
  ...
  def replace_invalid(bytes, replacement \\ "�")
    ...
    do_replace(bytes, Unicode.Validation.encode_replacement(replacement, :utf32), <<>>)
  end
  ...
  defp do_replace(<<codepoint::utf32, rest::bits>>, replacement, acc) do
    do_replace(rest, replacement, <<acc::bits, codepoint::utf32>>)
  end
