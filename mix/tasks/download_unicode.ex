if File.exists?(Unicode.data_dir()) do
  defmodule Mix.Tasks.Unicode.Download do
    ...
    @root_url "https://unicode.org/Public/UCD/latest/ucd"
    ...
    defp required_files do
      [
        ...
        {Path.join(root_url(), "/extracted/DerivedGeneralCategory.txt"), data_path("categories.txt")},
        {Path.join(root_url(), "/Blocks.txt"), data_path("blocks.txt")},
        {Path.join(root_url(), "/Scripts.txt"), data_path("scripts.txt")},
        {Path.join(root_url(), "/DerivedCoreProperties.txt"), data_path("derived_properties.txt")},
        {Path.join(root_url(), "/extracted/DerivedCombiningClass.txt"), data_path("combining_class.txt")},
        {Path.join(root_url(), "/emoji/emoji-data.txt"), data_path("emoji.txt")},
        {Path.join(root_url(), "/PropertyValueAliases.txt"), data_path("property_value_alias.txt")},
        ...
        {Path.join(root_url(), "/auxiliary/GraphemeBreakProperty.txt"), data_path("grapheme_break.txt")},
