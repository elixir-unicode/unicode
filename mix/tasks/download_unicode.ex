if File.exists?(Unicode.data_dir()) do
  defmodule Mix.Tasks.Unicode.Download do
    ...
    defp required_files do
      [
        {Path.join(root_url(), "/UnicodeData-14.0.0d13.txt"), data_path("unicode_data.txt")},
        {Path.join(root_url(), "/extracted/DerivedGeneralCategory-14.0.0d19.txt"), data_path("categories.txt")},
        {Path.join(root_url(), "/Blocks-14.0.0d4.txt"), data_path("blocks.txt")},
        {Path.join(root_url(), "/Scripts-14.0.0d19.txt"), data_path("scripts.txt")},
        {Path.join(root_url(), "/DerivedCoreProperties-14.0.0d21.txt"), data_path("derived_properties.txt")},
        {Path.join(root_url(), "/extracted/DerivedCombiningClass-14.0.0d19.txt"), data_path("combining_class.txt")},
        {Path.join(root_url(), "/emoji/emoji-data.txt"), data_path("emoji.txt")},
        {Path.join(root_url(), "/PropertyValueAliases-14.0.0d13.txt"), data_path("property_value_alias.txt")},
        {Path.join(root_url(), "/PropList-14.0.0d21.txt"), data_path("properties.txt")},
        {Path.join(root_url(), "/PropertyAliases-14.0.0d8.txt"), data_path("property_alias.txt")},
        {Path.join(root_url(), "/LineBreak-14.0.0d9.txt"), data_path("line_break.txt")},
        {Path.join(root_url(), "/auxiliary/WordBreakProperty-14.0.0d19.txt"), data_path("word_break.txt")},
        {Path.join(root_url(), "/auxiliary/GraphemeBreakProperty-14.0.0d21.txt"), data_path("grapheme_break.txt")},
        {Path.join(root_url(), "/auxiliary/SentenceBreakProperty-14.0.0d21.txt"), data_path("sentence_break.txt")},
        {Path.join(root_url(), "/IndicSyllabicCategory-14.0.0d4.txt"), data_path("indic_syllabic_category.txt")},
        {Path.join(root_url(), "/CaseFolding-14.0.0d8.txt"), data_path("case_folding.txt")},
        {Path.join(root_url(), "/SpecialCasing-14.0.0d8.txt"), data_path("special_casing.txt")},
        {Path.join(root_url(), "/EastAsianWidth-14.0.0d9.txt"), data_path("east_asian_width.txt")},
